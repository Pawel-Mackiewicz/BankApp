...
## 2025-03-03 - Konieczność Użycia ConcurrentHashMap

**Context:**
Dogłębna analiza systemu przetwarzania transakcji w kontekście współbieżności.

**Decision:**
ConcurrentHashMap jest konieczna ze względu na asynchroniczne przetwarzanie transakcji.

**Rationale:**
1. Asynchroniczne przetwarzanie:
   - Metody w TransactionService oznaczone @Async
   - processTransactionById i processAllNewTransactions działają w osobnych wątkach
   - Wiele transakcji może być przetwarzanych jednocześnie

2. Race conditions przy dostępie do mapy:
   - Różne wątki mogą próbować utworzyć lock dla tego samego konta
   - Potrzebna atomowa operacja sprawdzenia i utworzenia locka
   - ConcurrentHashMap.computeIfAbsent zapewnia atomowość

3. Wydajność:
   - Unikamy blokowania całej mapy
   - Pozwalamy na równoległe operacje na różnych buckach
   - Lepsze wykorzystanie wielu rdzeni procesora
