...
public class RegistrationRequest implements PasswordConfirmation {
    ...
    /**
     * Converts the raw PESEL string to a Pesel domain value object.
     *
     * @return a Pesel value object representing the user's PESEL number
     */
    ...
    /**
     * Converts the raw email string to an EmailAddress domain value object.
     *
     * @return an EmailAddress value object representing the user's email address
     */
    ...
    /**
     * Converts the raw phone number string to a PhoneNumber domain value object.
     *
     * @return a PhoneNumber value object representing the user's phone number
     */
